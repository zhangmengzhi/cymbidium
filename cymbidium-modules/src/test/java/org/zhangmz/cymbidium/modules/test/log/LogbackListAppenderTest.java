 ...
 *******************************************************************************/
package org.zhangmz.cymbidium.modules.test.log;
...
//		// name
//		appender.clearLogs();
//		appender.addToLogger("org.zhangmz.cymbidium.modules.test.log");
//		logger.warn(testString);
//		assertThat(appender.getFirstLog()).isNotNull();
//
//		appender.clearLogs();
//		appender.removeFromLogger("org.zhangmz.cymbidium.modules.test.log");
//		logger.warn(testString);
//		assertThat(appender.getFirstLog()).isNull();
//	}
}
