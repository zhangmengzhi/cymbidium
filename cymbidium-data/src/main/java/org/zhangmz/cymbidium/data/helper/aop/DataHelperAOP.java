 ...
 *******************************************************************************/
package org.zhangmz.cymbidium.data.helper.aop;
...
@Aspect
@Component
public class DataHelperAOP {
	private static Logger logger = LoggerFactory.getLogger(DataHelperAOP.class);
